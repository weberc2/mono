...
// Compare compares two tokens; however, it does a string comparison which
// *may* return false if the two tokens aren't exact copies (e.g., if they were
// generated by separate systems based off of the same input data and keys,
// this function may still return false). The correct way to compare tokens is
// to decode each with the public key used to generate the `wanted` token.
